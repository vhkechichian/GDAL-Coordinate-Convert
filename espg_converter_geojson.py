...
# date: 23/Aug/2022
# converts coords from iplan geojson to proper lat, longs in new geojson
...
for item in file_list:
    try:
        ...
        outfile = "%s/%s" % (settings.GEOJSON_NEW, item)
        # -------------------------
        # call function to transform geojson file
        util_gen.geojson2geojson("GeoJSON", infile, outfile, "EPSG:900913", "EPSG:4326")
